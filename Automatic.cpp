...
void Automatic::setPressure(){
	std::string tag="Change pressure";
	std::string pressure;
...
void Automatic::run(){
	...
	while(automatic){
		...
		//If the speed can't be changed for 6 tries and there is still pressure difference put boolean false to indicate user in LCD in print_Info
		if(timescalled > 6){
